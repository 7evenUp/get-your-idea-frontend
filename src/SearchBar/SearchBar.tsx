...
const SearchBar = () => {
  ...
  const onButtonClick = async () => {
    ...
    const res1 = await fetch(`https://api.wordassociations.net/associations/v1.0/json/search?apikey=${apiKey}&text=${inputText}&lang=ru&type=stimulus&limit=10&pos=noun,verb`)
    const data1 = await res1.json()
    const res2 = await fetch(`https://api.wordassociations.net/associations/v1.0/json/search?apikey=${apiKey}&text=${inputText}&lang=ru&type=response&limit=10&pos=noun,verb`)
